...
export const serviceIntro = {
  ...
  features: [
    ...
    { title: "AI 수강 추천", desc: "졸업요건 · 평점 · 학번 · 학과 데이터를 바탕으로 추천 (Gemini API 사용) 받아볼 수 있습니다.", image: null },
...
export const troubleshooting = [
  ...
  {
    title: "학생마다 다르게 생긴 성적표 양식 문제 원인 파악 (해결 중)",
...
export const designInsights = [
  ...
  {
    title: "보안과 데이터 정합성을 고려한 해시 및 식별자 설계",
    body:
      "사용자 식별에는 결정론적 해시를, 토큰 갱신에는 비결정론적 암호화를 사용하여 보안성과 정합성을 동시에 확보했습니다. \n provider_id_hash는 항상 동일한 해시값을 생성하여 계정 재가입 시에도 데이터 중복을 방지하고 신뢰도 점수를 안정적으로 유지합니다. \n 특히 보안을 위해 카카오 원본 ID 대신 내부 식별자(UUID) 기반의 매핑 구조를 도입하여, 추후 SALT 변경 시에도 기존 데이터와의 연결이 끊기지 않는 무중단 마이그레이션 전략을 수립했습니다. \n 활동 기록에는 해시값을 일부러 남겨두어 보안과 데이터 보존 사이의 균형을 맞췄습니다.",
    code: null,
